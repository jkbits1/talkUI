...
Elm.Main.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $PuzzleModule = Elm.PuzzleModule.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var updateModel = F2(function (update,
   _v0) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple3":
                 ...
                 switch (_v0._1.ctor)
                   {case "_Tuple5":
                      return function () {
                           ...
                           buttonStates) {
                              return function () {
                                 var ansLoop = $PuzzleModule.makeAnsLoop(s4);
                                 var thrLoop = $PuzzleModule.makeThrLoop(s3);
                                 var secLoop = $PuzzleModule.makeSecLoop(s2);
                                 var answers = $PuzzleModule.wheelPositionFromString(s4);
                                 var first = $PuzzleModule.wheelPositionFromString(s1);
                                 return {ctor: "_Tuple3"
                                        ,_0: {ctor: "_Tuple5"
                                             ,_0: i
                                             ,_1: s1
                                        ...
                                        ,_2: {ctor: "_Tuple7"
                                             ...
                                             ,_2: thrLoop
                                             ,_3: ansLoop
                                             ,_4: A2($PuzzleModule.twoWheelPerms,
                                             first,
                                             secLoop)
                                             ,_5: A3($PuzzleModule.threeLoopPerms,
                                             first,
                                             secLoop,
                                             thrLoop)
                                             ,_6: {ctor: "_Tuple5"
                                                  ,_0: A3($PuzzleModule.answersPlusPerm,
                                                  first,
                                                  secLoop,
                                                  thrLoop)
                                                  ,_1: A4($PuzzleModule.findSpecificAnswer,
                                                  first,
                                                  secLoop,
                                                  thrLoop,
                                                  ansLoop)
                                                  ,_2: A3($PuzzleModule.answersPermsPlusList,
                                                  first,
                                                  secLoop,
                                                  thrLoop)
                                                  ,_3: A4($PuzzleModule.displaySpecificAnswers,
                                                  first,
                                                  secLoop,
                                                  thrLoop,
                                                  answers)
                                                  ,_4: A4($PuzzleModule.findAnswerLazy3,
                                                  first,
                                                  secLoop,
                                                  thrLoop,
                                                  ansLoop)}}};
                           ...
                           return function () {
                              ...
                              {case "Add":
                                 ...
                                 return A6(createModel,
                                   ...
                                   ,_4: _v0._1._4});}
                              _U.badCase($moduleName,
                              "between lines 345 and 357");
                           }();
                        }();}
                   break;}
              break;}
         _U.badCase($moduleName,
         "between lines 327 and 357");
      }();
   });
   var displayStyle = function (show) {
      return function () {
         switch (show)
         {case false:
            return _L.fromArray([{ctor: "_Tuple2"
   ...
   var textStyle = _L.fromArray([{ctor: "_Tuple2"
                                 ,_0: "width"
                                 ,_1: "100%"}
                                ,{ctor: "_Tuple2"
                                 ,_0: "padding"
                                ...
                                ,{ctor: "_Tuple2"
                                 ,_0: "text-align"
                                 ,_1: "left"}]);
   var myStyle = _L.fromArray([{ctor: "_Tuple2"
                               ,_0: "width"
                               ,_1: "100%"}
                              ,{ctor: "_Tuple2"
                               ,_0: "height"
                              ...
                              ,{ctor: "_Tuple2"
                               ,_0: "text-align"
                               ,_1: "center"}]);
   var wheelStyle = _L.fromArray([{ctor: "_Tuple2"
                                  ,_0: "min-width"
                                  ,_1: "200px"}]);
   var wheelOnlyRow = F3(function (idx,
   wheelLabel,
   wheelData) {
      return A2($Html.div,
      ...
      _L.fromArray([A2($Html.div,
                   ...
                   _L.fromArray([$Html.text(wheelLabel)]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col-sm-2")]),
                   _L.fromArray([$Html.text(wheelData)]))]));
   });
   var inputField2 = F6(function (idVal,
   $default,
   text,
   chnlAddress,
   updateItem,
   inputStyle) {
      ...
      _L.fromArray([$Html$Attributes.placeholder($default)
                   ,$Html$Attributes.value(text)
                   ,A3($Html$Events.on,
                   "input",
                   $Html$Events.targetValue,
                   function ($) {
                      return $Signal.message(chnlAddress)(updateItem($));
                   })
                   ,$Html$Attributes.style(wheelStyle)
                   ,$Html$Attributes.id(idVal)
                   ,$Html$Attributes.$class("form-control col-sm-2")]),
      _L.fromArray([]));
   });
   var formGroup = F6(function (lbl,
   idVal,
   val,
   chnlAddress,
   updateItem,
   style) {
      ...
      _L.fromArray([A2($Html.label,
                   _L.fromArray([$Html$Attributes.$for(idVal)
   ...
   var inputField = F5(function ($default,
   text,
   chnlAddress,
   updateItem,
   inputStyle) {
      ...
      _L.fromArray([$Html$Attributes.placeholder($default)
                   ...
                   ,$Html$Attributes.style(inputStyle)]),
      _L.fromArray([]));
   });
   var ShowLoopAns = {ctor: "ShowLoopAns"};
   var ShowLoop3 = {ctor: "ShowLoop3"};
   var ShowLoop2 = {ctor: "ShowLoop2"};
   var Circle4Field = function (a) {
      return {ctor: "Circle4Field"
             ,_0: a};
   };
   var Circle3Field = function (a) {
      return {ctor: "Circle3Field"
             ,_0: a};
   };
   var Circle2Field = function (a) {
      return {ctor: "Circle2Field"
             ,_0: a};
   };
   ...
   var NoOp = {ctor: "NoOp"};
   var updatesChnl = $Signal.mailbox(NoOp);
   var addButton = A2($Html.button,
   _L.fromArray([A2($Html$Events.onClick,
   updatesChnl.address,
   Add(1))]),
   _L.fromArray([$Html.text("Show Answers")]));
   var showLoopButton = F2(function (label,
   action) {
   ...
   hide) {
      ...
      _L.fromArray([A2($Html.div,
                   ...
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col-sm-2")]),
                   _L.fromArray([A2(showLoopButton,
                   "Show ",
                   action)]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col-sm-2")
                                ,$Html$Attributes.style(displayStyle(hide))]),
                   _L.fromArray([$Html.text(loopLabel)]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col-sm-2")
                                ,$Html$Attributes.style(displayStyle(hide))]),
                   _L.fromArray([$Html.text(loopData)]))]));
   });
   var view = F2(function (updatesChnlAddress,
   _v23) {
      return function () {
         switch (_v23.ctor)
         {case "_Tuple3":
            switch (_v23._0.ctor)
                                ...
                                return A2($Html.div,
                                  ...
                                  _L.fromArray([A2($Html.div,
                                               ...
                                               _L.fromArray([addButton
                                                            ,A2($Html.div,
                                                            _L.fromArray([]),
                                                            _L.fromArray([$Html.text($Basics.toString(_v23._0._0))]))
                                                            ,A2($Html.div,
                                                            _L.fromArray([]),
                                                            _L.fromArray([$Html.text($Basics.toString(_v23._1._0))]))
                                                            ,A2($Html.div,
                                                            _L.fromArray([$Html$Attributes.style(A2($Basics._op["++"],
                                                            textStyle,
                                                            displayStyle(_v23._1._0)))]),
                                                            _L.fromArray([$Html.text(A2($Basics._op["++"],
                                                            "answersPlus - ",
                                                            $Basics.toString(_v23._2._6._0)))]))
                                                            ,A2($Html.div,
                                                            _L.fromArray([$Html$Attributes.style(A2($Basics._op["++"],
                                                            textStyle,
                                                            displayStyle(_v23._1._0)))]),
              ...
              break;}
         _U.badCase($moduleName,
         "between lines 215 and 272");
      }();
   });
   var updateModelLift = A3($Signal.foldp,
   updateModel,
   {ctor: "_Tuple3"
   ,_0: {ctor: "_Tuple5"
        ,_0: 0
   ...
   ,_1: {ctor: "_Tuple5"
        ...
        ,_4: true}
   ,_2: {ctor: "_Tuple7"
        ,_0: _L.fromArray([1,2,3])
        ,_1: _L.fromArray([_L.fromArray([4
                                        ,5
                                        ,6])])
        ,_2: _L.fromArray([_L.fromArray([7
                                        ,8
                                        ,9])])
        ,_3: _L.fromArray([_L.fromArray([12
                                        ,15
                                        ,18])])
        ,_4: _L.fromArray([_L.fromArray([_L.fromArray([2])])])
        ,_5: _L.fromArray([_L.fromArray([_L.fromArray([3])])])
        ,_6: {ctor: "_Tuple5"
             ,_0: _L.fromArray([{ctor: "_Tuple2"
                                ,_0: _L.fromArray([1])
                                ,_1: _L.fromArray([_L.fromArray([1])])}])
             ,_1: _L.fromArray([{ctor: "_Tuple2"
                                ,_0: _L.fromArray([1])
                                ,_1: _L.fromArray([_L.fromArray([1])])}])
             ,_2: _L.fromArray([{ctor: "_Tuple2"
                                ,_0: _L.fromArray([_L.fromArray([1])])
                                ,_1: _L.fromArray([_L.fromArray([1])])}])
             ,_3: _L.fromArray([{ctor: "_Tuple2"
                                ,_0: _L.fromArray([_L.fromArray([1])])
                                ,_1: _L.fromArray([_L.fromArray([1])])}])
             ,_4: {ctor: "_Tuple2"
                  ,_0: _L.fromArray([1])
                  ,_1: _L.fromArray([_L.fromArray([1])])}}}},
   updatesChnl.signal);
   var viewLift = A2($Signal.map,
   view(updatesChnl.address),
   updateModelLift);
   var main = viewLift;
   _elm.Main.values = {_op: _op
                      ...
                      ,Circle2Field: Circle2Field
                      ,Circle3Field: Circle3Field
                      ,Circle4Field: Circle4Field
                      ,ShowLoop2: ShowLoop2
                      ,ShowLoop3: ShowLoop3
                      ,ShowLoopAns: ShowLoopAns
                      ,updatesChnl: updatesChnl
                      ,addButton: addButton
                      ,showLoopButton: showLoopButton
                      ,inputField: inputField
                      ,inputField2: inputField2
                      ,formGroup: formGroup
                      ,wheelOnlyRow: wheelOnlyRow
                      ,wheelRow: wheelRow
                      ...
                      ,viewLift: viewLift
                      ,view: view
                      ,updateModelLift: updateModelLift
...
Elm.PuzzleModule = Elm.PuzzleModule || {};
Elm.PuzzleModule.make = function (_elm) {
   "use strict";
   _elm.PuzzleModule = _elm.PuzzleModule || {};
   if (_elm.PuzzleModule.values)
   return _elm.PuzzleModule.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "PuzzleModule",
   $Basics = Elm.Basics.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var initCounter = _L.fromArray([0
                                  ,0
                                  ,0]);
   var headCounter = A2($List.foldr,
   F2(function (h,t) {
      return h;
   }),
   0);
   var quotRem = F2(function (a,
   b) {
      return function () {
         var quot = A2(F2(function (x,
         y) {
            return x / y | 0;
         }),
         a,
         ...
         return {ctor: "_Tuple2"
                ,_0: quot
                ,_1: A2($Basics.rem,a,b)};
      }();
   });
   var digitsRev = F2(function (base,
   n) {
      return function () {
         switch (n)
         {case 0:
            return _L.fromArray([]);}
         return function () {
            var $ = A2(quotRem,n,base),
            rest = $._0,
            lastDigit = $._1;
            return A2($List._op["::"],
            lastDigit,
            A2(digitsRev,base,rest));
         }();
      }();
   });
   var digits = function (base) {
      return function ($) {
         return $List.reverse(digitsRev(base)($));
      };
   };
   var getCounter = function (x) {
      return function () {
         var _v1 = _U.cmp(x,512) > -1;
         switch (_v1)
         {case false:
            return function () {
                 var xs = A2(digits,8,x);
                 return function () {
                    var _v2 = $List.length(xs);
                    switch (_v2)
                    {case 0: return {ctor: "_Tuple2"
                                    ,_0: x
                                    ,_1: _L.fromArray([0,0,0])};
   ...
   var elem2 = F2(function (a,
   answerLoop) {
      return function () {
         switch (answerLoop.ctor)
         {case "::": return function () {
                 var _v6 = _U.eq(answerLoop._0,
                 a);
                 switch (_v6)
                 {case false:
                    return function () {
                         var _v7 = _U.eq(answerLoop._1,
                         _L.fromArray([]));
                         switch (_v7)
                         {case false: return A2(elem2,
                              a,
                              answerLoop._1);
   ...
   var headX = function (xs) {
      return function () {
         var h = $List.head(xs);
         return function () {
            switch (h.ctor)
            {case "Just": return h._0;
               case "Nothing":
               return {ctor: "_Tuple2"
                      ,_0: _L.fromArray([_L.fromArray([0])])
                      ,_1: _L.fromArray([_L.fromArray([0])])};}
            _U.badCase($moduleName,
            "between lines 172 and 174");
         }();
      }();
   };
   var headLLIxx = function (xs) {
      return function () {
         var h = $List.head(xs);
         return function () {
            switch (h.ctor)
   ...
   var headLLI = A2($List.foldr,
   F2(function (h,t) {
      return h;
   }),
   _L.fromArray([]));
   var wheelPermsItem = F2(function (idx,
   loop) {
      return headLLI(A2($List.drop,
      idx,
      loop));
   });
   var threeWheelsPermsItemByCounter = F4(function (first,
   secLoop,
   thrLoop,
   _v12) {
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 var thr_idx = headCounter(A2($List.drop,
                 1,
                 _v12._1));
                 var sec_idx = headCounter(_v12._1);
                 return A2($Basics._op["++"],
                 _L.fromArray([first]),
                 A2($Basics._op["++"],
                 _L.fromArray([A2(wheelPermsItem,
                 sec_idx,
                 secLoop)]),
                 _L.fromArray([A2(wheelPermsItem,
                 thr_idx,
         ...
         _U.badCase($moduleName,
         "between lines 235 and 242");
      }();
   });
   var zip3 = F3(function (pos1,
   pos2,
   pos3) {
      return A4($List.map3,
   ...
   var getSpecificPos = function (pos) {
      return function ($) {
         return headLLI($List.drop(pos)($));
      };
   };
   var columnsFromPermutation = function (perm) {
      return function () {
         var thrPos = headLLI(A2($List.drop,
         2,
         perm));
         var secPos = headLLI(A2($List.drop,
         1,
         perm));
         var firstPos = A2(getSpecificPos,
         0,
         perm);
         return A3(zip3,
         firstPos,
   ...
   var wheelsTuple = function (xxs) {
      return function () {
         var thr = A2(getSpecificPos,
         2,
         xxs);
         var sec = A2(getSpecificPos,
         1,
         xxs);
         var inn = A2(getSpecificPos,
         0,
         xxs);
         return A3(zip3,inn,sec,thr);
      }();
   };
   var sumColumn = function (_v16) {
      return function () {
         switch (_v16.ctor)
         {case "_Tuple3":
            return _v16._0 + _v16._1 + _v16._2;}
         _U.badCase($moduleName,
         "on line 89, column 23 to 32");
      }();
   };
   var sumPlusPerm = function (perm) {
      return _L.fromArray([{ctor: "_Tuple2"
                           ,_0: $List.map(sumColumn)(columnsFromPermutation(perm))
                           ,_1: perm}]);
   };
   var getWheelsPermAnswers = F4(function (first,
   secLoop,
   thrLoop,
   n) {
      return $List.map(sumColumn)(wheelsTuple(A3(threeWheelsPermsItemByCounter,
      first,
      secLoop,
      thrLoop)(getCounter(n))));
   });
   var findAnswerLazy3 = F4(function (first,
   secLoop,
   thrLoop,
   ansLoop) {
      return function () {
         var ansIdx = headCounter($List.map(function (_v25) {
            return function () {
               switch (_v25.ctor)
               {case "_Tuple2":
                  return _v25._0;}
               _U.badCase($moduleName,
               "on line 265, column 23 to 24");
            }();
         })($List.filter(function (_v21) {
            return function () {
               switch (_v21.ctor)
               {case "_Tuple2":
                  return _U.eq(_v21._1,true);}
               _U.badCase($moduleName,
               "on line 266, column 28 to 37");
            }();
         })(A2($List.map,
         function (i) {
            return {ctor: "_Tuple2"
         ...
         _L.range(1,512)))));
         var answers = A4(getWheelsPermAnswers,
         first,
         secLoop,
         thrLoop,
         ansIdx);
         var loopsPerm = A3(threeWheelsPermsItemByCounter,
         first,
         secLoop,
         thrLoop)(getCounter(ansIdx));
         return {ctor: "_Tuple2"
                ,_0: answers
                ,_1: loopsPerm};
      }();
   });
   var appendTwoWheelPerms = F2(function (twoWheelPermsLocal,
   thrPos) {
      return A2($List.map,
   ...
   var twoWheelPerms = F2(function (first,
   secLoop) {
      return A2($List.map,
   ...
   var threeLoopPerms = F3(function (first,
   secLoop,
   thrLoop) {
      return function () {
         var addPosToTwoWheelPerms = appendTwoWheelPerms(A2(twoWheelPerms,
         first,
         secLoop));
         return $List.concat(A2($List.map,
         addPosToTwoWheelPerms,
         thrLoop));
      }();
   });
   var answersPlusPerm = F3(function (first,
   secLoop,
   thrLoop) {
      return $List.concat($List.map(sumPlusPerm)(A3(threeLoopPerms,
      first,
      secLoop,
      thrLoop)));
   });
   var findSpecificAnswer = F4(function (first,
   secLoop,
   thrLoop,
   answersLoop) {
      return $List.filter(function (_v29) {
         return function () {
            switch (_v29.ctor)
            {case "_Tuple2":
               return A2(elem2,
   ...
   var turnWheel = F2(function (wheel,
   turns) {
      return A2($Basics._op["++"],
      A2($List.drop,turns,wheel),
      A2($List.take,turns,wheel));
   });
   var getWheelLoop = F3(function (positions,
   pos,
   count) {
      return function () {
         switch (count)
         {case 0:
            return A2($Basics._op["++"],
              _L.fromArray([pos]),
              positions);}
         return A3(getWheelLoop,
         A2($Basics._op["++"],
         _L.fromArray([A2(turnWheel,
         pos,
         count)]),
         positions),
         pos,
   ...
   var createWheelLoop = function (initialPos) {
      return A3(getWheelLoop,
      _L.fromArray([]),
      initialPos,
      $List.length(initialPos) - 1);
   };
   var answersPermsLoop2 = function (_v34) {
      return function () {
         switch (_v34.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ,_0: createWheelLoop(_v34._0)
                   ,_1: _v34._1};}
         _U.badCase($moduleName,
         "on line 138, column 35 to 61");
      }();
   };
   var answersPermsPlusList = F3(function (first,
   secLoop,
   thrLoop) {
      return $List.map(answersPermsLoop2)(A3(answersPlusPerm,
      first,
      secLoop,
      thrLoop));
   });
   var findSpecificAnswerPlusList = F4(function (first,
   secLoop,
   thrLoop,
   answers) {
      return $List.filter(function (_v38) {
         return function () {
            switch (_v38.ctor)
            {case "_Tuple2":
               return A2(elem2,
                 ...
                 _v38._0);}
            _U.badCase($moduleName,
            "on line 149, column 30 to 47");
         }();
      })(A3(answersPermsPlusList,
      first,
      secLoop,
      thrLoop));
   });
   var displaySpecificAnswers = F4(function (first,
   secLoop,
   thrLoop,
   answers) {
      return function (h) {
         return _L.fromArray([h]);
      }(headX(A4(findSpecificAnswerPlusList,
      first,
      secLoop,
      thrLoop,
      answers)));
   });
   var resToNum = function (r) {
      return function () {
         switch (r.ctor)
         {case "Err": return 0;
            case "Ok": return r._0;}
   ...
   var strToNum = function (s) {
      return resToNum($String.toInt(s));
   };
   var wheelPositionFromString = function (s) {
      return A2($List.map,
      strToNum,
      A2($String.split,",",s));
   };
   var generateWheelLoop = function (s) {
      return createWheelLoop(wheelPositionFromString(s));
   };
   var makeSecLoop = generateWheelLoop;
   var makeThrLoop = generateWheelLoop;
   var makeAnsLoop = generateWheelLoop;
   _elm.PuzzleModule.values = {_op: _op
                              ,strToNum: strToNum
                              ,resToNum: resToNum
                              ,wheelPositionFromString: wheelPositionFromString
                              ,turnWheel: turnWheel
                              ,getWheelLoop: getWheelLoop
                              ,createWheelLoop: createWheelLoop
                              ,generateWheelLoop: generateWheelLoop
                              ,makeSecLoop: makeSecLoop
                              ,makeThrLoop: makeThrLoop
                              ,makeAnsLoop: makeAnsLoop
                              ,twoWheelPerms: twoWheelPerms
                              ,appendTwoWheelPerms: appendTwoWheelPerms
                              ,threeLoopPerms: threeLoopPerms
                              ,sumColumn: sumColumn
                              ,getSpecificPos: getSpecificPos
                              ,columnsFromPermutation: columnsFromPermutation
                              ,zip3: zip3
                              ,headLLI: headLLI
                              ,headLLIxx: headLLIxx
                              ,sumPlusPerm: sumPlusPerm
                              ,answersPlusPerm: answersPlusPerm
                              ,findSpecificAnswer: findSpecificAnswer
                              ,answersPermsLoop2: answersPermsLoop2
                              ,answersPermsPlusList: answersPermsPlusList
                              ,findSpecificAnswerPlusList: findSpecificAnswerPlusList
                              ,displaySpecificAnswers: displaySpecificAnswers
                              ,headX: headX
                              ,elem2: elem2
                              ,quotRem: quotRem
                              ,digitsRev: digitsRev
                              ...
                              ,wheelPermsItem: wheelPermsItem
                              ,headCounter: headCounter
                              ,threeWheelsPermsItemByCounter: threeWheelsPermsItemByCounter
                              ,wheelsTuple: wheelsTuple
                              ,getWheelsPermAnswers: getWheelsPermAnswers
                              ,findAnswerLazy3: findAnswerLazy3
